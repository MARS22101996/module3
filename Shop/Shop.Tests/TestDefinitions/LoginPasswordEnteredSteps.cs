...
{
    [Binding]
    public class LoginPasswordEnteredSteps
    {
        private LoginViewModel _loginModel = new LoginViewModel();
        private ViewResult _result;

        [Given(@"User enter password Test@(.*)")]
        public void GivenUserEnterPasswordTest(int p0)
        {
            _loginModel.Email = "123";
        }
        
        [When(@"Click on the button for log in")]
        public void WhenClickOnTheButtonForLogIn()
        {
